    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
		...
		$(document).ready(function() {
 		...
 		$('#btn_correo2').click(function() {
 			...
 			if( $('#nombre_correo2').val() == "" ){

 				bootbox.alert("<strong>Agregar el Nombre del Contacto 2</strong>");

 			}else{
 				if( $('#email_correo2').val() == "" ){

 						bootbox.alert("<strong>Agregar el Correo del Contacto 2</strong>");

 				  }else{
 				  	  if( $('#asunto_correo2').val() == "" ){

 				  	  	  bootbox.alert("<strong>Agregar Asunto del Correo 2</strong>");
 			...
 			datos_enviar.append('nombre_correo', $('#nombre_correo2').val()  );
 			datos_enviar.append('email_correo', $('#email_correo2').val() );
 			datos_enviar.append('asunto_correo', $('#asunto_correo2').val() );
 			datos_enviar.append('texto_correo', $('#texto_correo2').val() );
				    ...
				    <div class="modal-content"> <!--ESTRUCTURA DEL MODAL-->
				      ...
				      <div class="modal-body"> <!--CUERPO DEL MODAL-->
				      	...
				      	<form id="correo">
												<div class="input-group">
								    				<span class="input-group-addon" id="sizing-addon1">Nombre</span>
								   					<input type="text" class="form-control" name="nombre_correo" id="nombre_correo2" placeholder="Nombre">
								  				</div>
								  				...
								  				<div class="input-group">
								    				<span class="input-group-addon" id="sizing-addon1">Email</span>
								   					<input type="text" class="form-control" name="email_correo" id="email_correo2" placeholder="Ingresa tu Email">
								  				</div>
								  				...
								  				<div class="input-group">
								    				<span class="input-group-addon" id="sizing-addon1">Asunto</span>
								   					<input type="text" class="form-control" name="asunto_correo" id="asunto_correo2">
								  				</div>

								  				<br>

								  				<textarea class="form-control" rows="4" name="texto_correo" id="texto_correo2"></textarea>
