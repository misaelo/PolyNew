...
<header class="box">
		...
		<div class="logo2 visible-xs"></div>	
</header>
	   		...
	   		<div class="col-xs-12 col-sm-8">
				...
				<div class="col-xs-12 col-sm-4">
						 <div class="jumbotron" id="jumbo-informacion">
	       					...
	       					<p>click en <strong>like</strong> para seguirnos en Facebook <a href="https://www.facebook.com/Polysport-827539447352809/info/?tab=page_info"><i class="fa fa-thumbs-o-up fa-2x"></i></a></p>
	       				</div>  
