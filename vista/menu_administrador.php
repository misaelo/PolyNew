  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> <!--menu de la izquierda por defecto-->
      <ul class="nav navbar-nav">
        ...
        <ul class="nav navbar-nav"> <!--MENU DE LA DERECHA CON LA CLASE NAV-BAR RIGHT -->
          <li><a href="http://www.polysport.cl/cpanel">Administrador Host</a></li>
        </ul>

        <ul class="nav navbar-nav"> <!--MENU DE LA DERECHA CON LA CLASE NAV-BAR RIGHT -->
          <li><a href="http://www.polysport.cl/webmail">Mail</a></li>
        </ul>
